...
- Google SRE Workbook — _Implementing SLOs_, _Alerting on SLOs_
- OpenTelemetry Specification v1.30 — _Semantic Conventions_
- Prometheus Best Practices — _Naming_, _Labels_
- Grafana Loki — _Multi-tenant_, _Storage_
- CIS Controls v8 — _08 Audit Log Management_ (mapped in `docs/compliance/cis-nist-mapping.md`)
- NIST SP 800-53 Rev. 5 — _AU family_ (mapped in `docs/compliance/cis-nist-mapping.md`)

---

_End of Monitoring, Logging & Metrics Architecture v1.0_
