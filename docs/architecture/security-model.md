...
> **Status**: Sprint 1 draft (GitOpsManager). SecurityArchitect to publish
> the canonical, detailed version in
> [`authentication-and-security-design.md`](./authentication-and-security-design.md).
> **Owner**: SecurityArchitect (canonical) / GitOpsManager (this draft)
