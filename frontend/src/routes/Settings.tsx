...
import { Building2, KeyRound, ScrollText, ShieldCheck, Users, Webhook } from 'lucide-react';
  ...
  const entries = [
    {
      ...
      actor: 'm.chen',
      action: 'role.assign',
      target: 'team:payments / compliance-reader',
    },
    {
      ts: '14m ago',
      actor: 'agent:remediator',
      action: 'policy.evaluate',
      target: 'auto-bump xz-utils',
    },
    ...
    >
      <ul className="divide-y divide-aion-border">
        {entries.map((e, i) => (
          <li
            key={i}
            className="grid grid-cols-[80px_140px_140px_1fr] items-center gap-3 py-2 text-sm"
          >
