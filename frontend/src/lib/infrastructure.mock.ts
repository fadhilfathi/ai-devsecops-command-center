...
export const mockWorkloads: Workload[] = [
  ...
  },
  {
    ...
    resources: {
      cpuRequestsMillicores: 2000,
      cpuLimitsMillicores: 4000,
      memoryRequestsBytes: 8 * 1024 * 1024 * 1024,
      memoryLimitsBytes: 16 * 1024 * 1024 * 1024,
    },
    lastSyncedAt: NOW(),
  },
];
    ...
    issues: [
      {
        ...
        detectedAt: NOW(),
        remediation: 'kubectl rollout restart',
      },
      {
        id: 'iss-2',
        kind: 'node_pressure',
        severity: 'high',
        message: 'Node ip-10-0-2-12 reports condition: disk_pressure',
        subject: {
          kind: 'Node',
          name: 'ip-10-0-2-12',
          clusterId: '11111111-1111-4111-8111-111111111111',
    ...
    recommendations: [
      {
        id: 'r-1',
        priority: 'p0',
        title: 'Restart crashing workloads',
        detail: '1 pod(s) are in CrashLoopBackOff.',
        action: 'kubectl rollout restart deploy -n default payments-api',
        ruleIds: ['crash_loop_back_off'],
        affectedCount: 1,
      },
      {
        id: 'r-2',
        priority: 'p2',
        title: 'Resolve node pressure',
        detail: '1 node(s) report pressure.',
        action: 'kubectl drain ip-10-0-2-12',
        ruleIds: ['node_pressure'],
        affectedCount: 1,
      },
    ],
    generatedAt: NOW(),
...
export const mockRuntimeRisks: RuntimeRisk[] = [
  {
    ...
    subject: 'pod',
    subjectKind: 'Pod',
    subjectName: 'legacy-tool-1-abcd',
    ruleId: 'AICC-RT-001',
    ...
    evidencePath: 'pod.spec.containers[app].securityContext.privileged',
    evidenceValue: true,
  ...
  },
  {
    ...
    subjectName: 'legacy-tool-1-abcd',
    ruleId: 'AICC-RT-004',
    ruleName: 'Dangerous Linux capability',
    category: 'dangerous_capability',
    level: 'critical',
    severity: 'critical',
    message: 'Container app adds dangerous capability SYS_ADMIN',
    evidencePath: 'pod.spec.containers[app].securityContext.capabilities.add',
    evidenceValue: 'SYS_ADMIN',
    remediation:
...
export const mockRuntimeReport: RuntimeSecurityReport = {
  ...
  categoryCounts: {
    ...
    root_user: 1,
    image_risk: 1,
    unsafe_security_context: 1,
  },
  findings: mockRuntimeRisks,
  recommendations: [
    {
      id: 'rec-1',
      title: 'Fix: Privileged container',
      detail: 'Drop securityContext.privileged and use a narrowly-scoped capabilities set.',
      level: 'critical',
      affectedCount: 1,
    },
    {
      id: 'rec-2',
      title: 'Fix: Dangerous Linux capability',
      detail:
        'Drop the dangerous capability. If required, use capabilities.add with the minimal set.',
      level: 'critical',
      affectedCount: 1,
...
export const mockWorkloadCosts: WorkloadCost[] = [
  {
    ...
    namespace: 'default',
    kind: 'deployment',
    currentMonthlyUsd: 86.4,
    recommendedMonthlyUsd: 86.4,
    potentialMonthlySavingsUsd: 0,
    utilisation: { cpuP50: 0.4, cpuP95: 0.6, memoryP50: 0.5, memoryP95: 0.7 },
    requests: { cpuMillicores: 250, memoryBytes: 512 * 1024 * 1024 },
    limits: { cpuMillicores: 1000, memoryBytes: 1024 * 1024 * 1024 },
  },
  {
    workloadId: 'w-2',
    workloadName: 'legacy-batch',
    namespace: 'default',
    kind: 'deployment',
    currentMonthlyUsd: 1305.6,
    recommendedMonthlyUsd: 408.0,
    potentialMonthlySavingsUsd: 897.6,
    utilisation: { cpuP50: 0.05, cpuP95: 0.12, memoryP50: 0.1, memoryP95: 0.2 },
    requests: { cpuMillicores: 2000, memoryBytes: 8 * 1024 * 1024 * 1024 },
    limits: { cpuMillicores: 4000, memoryBytes: 16 * 1024 * 1024 * 1024 },
  },
];
...
export const mockCostFindings: CostFinding[] = [
  {
    ...
    dimension: 'cpu',
    severity: 'medium',
    message: 'CPU p95 12% is well below request',
    workloadId: 'w-2',
    workloadName: 'legacy-batch',
    namespace: 'default',
  ...
  },
  {
    ...
    dimension: 'memory',
    severity: 'medium',
    message: 'Memory p95 20% is well below request',
    workloadId: 'w-2',
    workloadName: 'legacy-batch',
    namespace: 'default',
...
export const mockCostAnalysis: CostAnalysis = {
  ...
  currentMonthlyUsd: 1392,
  recommendedMonthlyUsd: 494,
  potentialMonthlySavingsUsd: 898,
  workloads: mockWorkloadCosts,
  findings: mockCostFindings,
  recommendations: mockCostRecommendations,
  generatedAt: NOW(),
};
  ...
  edges: [
    {
      ...
      kind: 'routes_to',
      weight: 1,
      label: 'api.example.com/payments→:80',
      metadata: {},
    },
    {
      id: 'e-2',
