...
export const mockVulnerabilities: Vulnerability[] = [
  ...
  },
  {
    id: 'vuln-502',
    cve: 'CVE-2024-21626',
    title: 'runc file descriptor leak (container escape)',
    severity: 'critical',
    cvss: 9.8,
    package: 'runc',
    version: '1.1.11',
  ...
  },
  {
    id: 'vuln-504',
    cve: 'CVE-2023-45878',
    title: 'MiniZip integer overflow',
    severity: 'medium',
    cvss: 6.5,
    package: 'minizip',
    version: '1.2.13',
  ...
  {
    id: 'vuln-505',
    title: 'Outdated base image (debian:bullseye)',
    severity: 'medium',
    cvss: 5.4,
    package: 'debian:bullseye',
    version: '20240130',
    fixedIn: 'debian:bookworm',
    status: 'open',
    assetId: 'ast-005',
    detectedAt: ago(60 * 24 * 3),
  },
  {
    id: 'vuln-506',
    cve: 'CVE-2024-2389',
  ...
  },
  {
    ...
    severity: 'low',
    cvss: 3.7,
    package: 'internal-payments-sdk',
    version: '0.4.2',
    status: 'in-progress',
    assetId: 'ast-002',
    detectedAt: ago(60 * 24 * 2),
  },
];
...
export const mockIncidents: Incident[] = [
  {
    id: 'inc-9001',
    title: 'Suspicious IAM role chain in prod',
    severity: 'critical',
  ...
  {
    id: 'inc-9002',
    title: 'CI runner token exposed in public log',
    severity: 'high',
    status: 'contained',
    assignee: 'r.patel',
    source: 'agent',
  ...
  {
    id: 'inc-9003',
    title: 'Dependency confusion attempt blocked',
    severity: 'medium',
    status: 'resolved',
    assignee: 'a.kowalski',
    source: 'agent',
  ...
  {
    id: 'inc-9004',
    title: 'CIS control 5.4 regression on prod',
    severity: 'low',
    status: 'open',
    assignee: 'unassigned',
    source: 'agent',
...
export const mockCompliance: ComplianceControl[] = [
  {
    id: 'c-1',
    family: 'CIS 1 — Inventory',
    framework: 'CISv8',
    title: 'Establish and Maintain Detailed Enterprise Asset Inventory',
    status: 'pass',
    evidenceCount: 14,
    lastAssessedAt: ago(60 * 5),
  },
  {
    id: 'c-2',
    family: 'CIS 5 — Access Control',
    framework: 'CISv8',
    title: 'MFA for All Administrative Access',
    status: 'pass',
    evidenceCount: 9,
    lastAssessedAt: ago(60 * 4),
  },
  {
    id: 'c-3',
    family: 'CIS 5 — Access Control',
    framework: 'CISv8',
    title: 'Disable Dormant Accounts within 60 Days',
    status: 'partial',
    evidenceCount: 4,
    lastAssessedAt: ago(60 * 9),
  },
  {
    id: 'c-4',
    family: 'CIS 7 — Vulnerability Mgmt',
    framework: 'CISv8',
    title: 'Automated Vulnerability Scanning of Internal Assets',
    status: 'pass',
    evidenceCount: 22,
    lastAssessedAt: ago(60 * 2),
  },
  {
    id: 'c-5',
    family: 'CIS 16 — App Security',
    framework: 'CISv8',
    title: 'Establish and Maintain a Process to Accept and Manage SBOMs',
    status: 'partial',
    evidenceCount: 3,
    lastAssessedAt: ago(60 * 8),
  },
  {
    id: 'c-6',
    family: 'NIST AC-02',
...
export const mockIntegrations: Integration[] = [
  ...
  { id: 'int-2', name: 'GitLab.com', category: 'scm', vendor: 'GitLab', status: 'disconnected' },
  {
    id: 'int-3',
    name: 'GitHub Actions',
    category: 'ci',
...
export const mockSbomFull: SbomComponentEnhanced[] = generateSbomComponents(0xa10c, 64);
...
function buildTimeline(range: VulnTimelineRange): VulnTimelinePoint[] {
  ...
  for (let i = days - 1; i >= 0; i--) {
    ...
    const label = useWeeks ? `W${Math.floor(days - 1 - i)}` : d.toISOString().slice(0, 10);
