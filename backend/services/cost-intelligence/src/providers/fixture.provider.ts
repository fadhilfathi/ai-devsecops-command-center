...
function makeDeployments(tenantId: string, opts: ListOptions): Deployment[] {
  return [
    // healthy + sized
    {
      ...
      rollout: 'complete' as DeploymentRolloutStatus,
      paused: false,
    },
    // over-provisioned CPU + memory
    {
      ...makeWorkload({
        ...
        resources: {
          cpuReq: 2000,
          cpuLim: 4000,
          memReq: 8 * 1024 * 1024 * 1024,
          memLim: 16 * 1024 * 1024 * 1024,
        },
      }),
      strategy: 'recreate',
      rollingUpdate: {},
      currentReplicaSet: 'legacy-batch-1',
      terminatingReplicas: 0,
      rollout: 'complete' as DeploymentRolloutStatus,
      paused: false,
    },
    // missing requests
    {
      ...
      strategy: 'rolling_update',
      rollingUpdate: { maxSurge: 1, maxUnavailable: 0 },
      currentReplicaSet: 'experimental-1',
      terminatingReplicas: 0,
      rollout: 'complete' as DeploymentRolloutStatus,
      paused: false,
    },
  ...
  return [
    {
      ...
      containers: [c('app', 'ghcr.io/example/payments-api:1.42.0', true, 0)],
