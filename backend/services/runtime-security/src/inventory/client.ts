/**
 * Inventory client (shared shape with the k8s-health service).
 * In Sprint 4 the runtime-security service uses the in-process
 * fixture provider; Sprint 5 will hit the kubernetes-service
 * HTTP API.
 */
